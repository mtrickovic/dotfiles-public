...
hl.bind(mainMod .. " + D", hl.dsp.layout("togglesplit"))    -- dwindle only (moved off J, was conflicting)
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("pidof hyprlock || hyprlock"))  -- lock screen, no-op if already locked

-- Move focus with mainMod + arrow keys, and mainMod + J/semicolon (left/right)
...
-- Laptop multimedia keys for volume and LCD brightness — via SwayOSD for the on-screen popup
...
hl.bind(mainMod .. " + G",       hl.dsp.group.toggle())   -- make current window a group / dissolve it
hl.bind(mainMod .. " + Tab",     hl.dsp.group.next())     -- next window in the group
hl.bind(mainMod .. " + SHIFT + Tab", hl.dsp.group.prev()) -- previous window in the group
hl.bind(mainMod .. " + SHIFT + G",   hl.dsp.group.lock()) -- lock group (no new windows auto-join)
